...
export const addPost = async (options) => {
  ...
  //   tags,
  // } = options;
  // const user = Number(uData('session'));
  // const username = uData('username');
  // const form = new FormData();
  // const file = await imageCompressor(targetFile);
  // const action = new Action('.p_post');
  //
  // action.start();
  // wait();
  //
  ...
  // const {
  //   data: {
  //     success, mssg, post_id, firstname, surname, filename,
  //   },
...
export const deletePost = async (options) => {
  // const {
  //   post_id, when, dispatch, redirect,
  // } = options;
  //
  // wait();
  //
...
export const like = async (options) => {
  // const { post_id, user, done } = options;
  // const {
  //   data: { success, mssg },
...
export const unbookmark = async (options) => {
  // const {
  //   post_id, when, user, dispatch, done,
  // } = options;
  // const session = uData('session');
  //
  // const {
  //   data: { success, mssg },
...
export const unshare = async (options) => {
  // const { user, post_id, done } = options;
  // new d('.share_btn').blur();
  //
  // const {
  //   data: { success, mssg },
